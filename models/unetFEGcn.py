...
class EdgeExpand(nn.Module):   
    def __init__(self,channels):
        ...
        kernel_x = torch.tensor(kernel_x, dtype=torch.float32, device='cuda').expand(channels, channels, 3, 3)
        kernel_y = torch.tensor(kernel_y, dtype=torch.float32, device='cuda').expand(channels, channels, 3, 3)
